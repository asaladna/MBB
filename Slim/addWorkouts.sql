-- use pocketgains database
USE pocketgains;

-- add workouts to Workout table
INSERT INTO Workout (title, description) VALUES ("Hammer Curls", "Stand up with your torso upright and a dumbbell on each hand being held at arms length. The elbows should be close to the torso.
The palms of the hands should be facing your torso. This will be your starting position.
Now, while holding your upper arm stationary, exhale and curl the weight forward while contracting the biceps. Continue to raise the weight until the biceps are fully contracted and the dumbbell is at shoulder level. Hold the contracted position for a brief moment as you squeeze the biceps. Tip: Focus on keeping the elbow stationary and only moving your forearm.
After the brief pause, inhale and slowly begin the lower the dumbbells back down to the starting position.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell Bicep Curl", "Stand up straight with a dumbbell in each hand at arm's length. Keep your elbows close to your torso and rotate the palms of your hands until they are facing forward. This will be your starting position.
Now, keeping the upper arms stationary, exhale and curl the weights while contracting your biceps. Continue to raise the weights until your biceps are fully contracted and the dumbbells are at shoulder level. Hold the contracted position for a brief pause as you squeeze your biceps.
Then, inhale and slowly begin to lower the dumbbells back to the starting position.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Barbell Curl", "Stand up with your torso upright while holding a barbell at a shoulder-width grip. The palm of your hands should be facing forward and the elbows should be close to the torso. This will be your starting position.
While holding the upper arms stationary, curl the weights forward while contracting the biceps as you breathe out. Tip: Only the forearms should move.
Continue the movement until your biceps are fully contracted and the bar is at shoulder level. Hold the contracted position for a second and squeeze the biceps hard.
Slowly begin to bring the bar back to starting position as your breathe in.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Bench Dips", "For this exercise you will need to place a bench behind your back. With the bench perpendicular to your body, and while looking away from it, hold on to the bench on its edge with the hands fully extended, separated at shoulder width. The legs will be extended forward, bent at the waist and perpendicular to your torso. This will be your starting position.
Slowly lower your body as you inhale by bending at the elbows until you lower yourself far enough to where there is an angle slightly smaller than 90 degrees between the upper arm and the forearm. Tip: Keep the elbows as close as possible throughout the movement. Forearms should always be pointing down.
Using your triceps to bring your torso up again, lift yourself back to the starting position.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Bicep Curl to Shoulder Press", "For this exercise you will need to place a bench behind your back. With the bench perpendicular to your body, and while looking away from it, hold on to the bench on its edge with the hands fully extended, separated at shoulder width. The legs will be extended forward, bent at the waist and perpendicular to your torso. This will be your starting position.
Slowly lower your body as you inhale by bending at the elbows until you lower yourself far enough to where there is an angle slightly smaller than 90 degrees between the upper arm and the forearm. Tip: Keep the elbows as close as possible throughout the movement. Forearms should always be pointing down.
Using your triceps to bring your torso up again, lift yourself back to the starting position.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Body-Up", "Assume a plank position on the ground. You should be supporting your body weight on your toes and forearms keeping your torso straight. Your forearms should be shoulder-width apart. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Cable Triceps Extension", "With your right hand, grasp a single handle attached to the high-cable pulley using a supinated (underhand; palms facing up) grip. You should be standing directly in front of the weight stack.
...
INSERT INTO Workout (title, description) VALUES ("Cable Preacher Curl", "Place a preacher bench about 2 feet in front of a pulley machine.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Cable Wrist Curl", "Start out by placing a flat bench in front of a low pulley cable that has a straight bar attachment.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Concentration Curls", "Sit down on a flat bench with one dumbbell in front of you between your legs. Your legs should be spread with your knees bent and feet on the floor.
...
INSERT INTO Workout (title, description) VALUES ("Dip Machine", "Sit securely in a dip machine, select the weight and firmly grasp the handles.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Dips - Triceps Version", "To get into the starting position, hold your body at arm's length with your arms nearly locked above the bars.
Now, inhale and slowly lower yourself downward. Your torso should remain upright and your elbows should stay close to your body. This helps to better focus on tricep involvement. Lower yourself until there is a 90 degree angle formed between the upper arm and forearm.
Then, exhale and push your torso back up using your triceps to bring your body back to the starting position.
Repeat the movement for the prescribed amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Drag Curl", "rab a barbell with a supinated grip (palms facing forward) and get your elbows close to your torso and back. This will be your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell Floor Press", "Lay on the floor holding dumbbells in your hands. Your knees can be bent. Begin with the weights fully extended above you.
...
INSERT INTO Workout (title, description) VALUES ("Dumbbell Lying Pronation", "Lie on a flat bench face down with one arm holding a dumbbell and the other hand on top of the bench folded so that you can rest your head on it.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell Lying Supination", "Lie sideways on a flat bench with one arm holding a dumbbell and the other hand on top of the bench folded so that you can rest your head on it.
Bend the elbows of the arm holding the dumbbell so that it creates a 90-degree angle between the upper arm and the forearm.
...
INSERT INTO Workout (title, description) VALUES ("Dumbbell One-Arm Triceps Extension", "Grab a dumbbell and either sit on a military press bench or a utility bench that has a back support on it as you place the dumbbells upright on top of your thighs or stand up straight.
...
INSERT INTO Workout (title, description) VALUES ("Finger Curls", "Hold a barbell with both hands and your palms facing up; hands spaced about shoulder width.
...
INSERT INTO Workout (title, description) VALUES ("Floor Press", "Adjust the j-hooks so they are at the appropriate height to rack the bar. Begin lying on the floor with your head near the end of a power rack. Keeping your shoulder blades pulled together; pull the bar off of the hooks.
...
INSERT INTO Workout (title, description) VALUES ("High Cable Curls", "Stand between a couple of high pulleys and grab a handle in each arm. Position your upper arms in a way that they are parallel to the floor with the palms of your hands facing you. This will be your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Kneeling Cable Triceps Extension", "Place a bench sideways in front of a high pulley machine.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Kneeling Forearm Stretch", "Start by kneeling on a mat with your palms flat and your fingers pointing back toward your knees.
...
INSERT INTO Workout (title, description) VALUES ("Low Cable Triceps Extension", "Select the desired weight and lay down face up on the bench of a seated row machine that has a rope attached to it. Your head should be pointing towards the attachment.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Lying Cable Curl", "Grab a straight bar or E-Z bar attachment that is attached to the low pulley with both hands, using an underhand (palms facing up) shoulder-width grip.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Lying Dumbbell Tricep Extension", "Lie on a flat bench while holding two dumbbells directly in front of you. Your arms should be fully extended at a 90-degree angle from your torso and the floor. The palms should be facing in and the elbows should be tucked in. This is the starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Lying High Bench Barbell Curl", "Lie face forward on a tall flat bench while holding a barbell with a supinated grip (palms facing up). Tip: If you are holding a barbell grab it using a shoulder-width grip and if you are using an E-Z Bar grab it on the inner handles. Your upper body should be positioned in a way that the upper chest is over the end of the bench and the barbell is hanging in front of you with the arms extended and perpendicular to the floor. This will be your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Lying Supine Dumbbell Curl", "Lie down on a flat bench face up while holding a dumbbell in each arm on top of your thighs.
...
INSERT INTO Workout (title, description) VALUES ("Machine Bicep Curl", "Adjust the seat to the appropriate height and make your weight selection. Place your upper arms against the pads and grasp the handles. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Machine Preacher Curls", "Sit down on the Preacher Curl Machine and select the weight.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("One Arm Dumbbell Preacher Curl", "Grab a dumbbell with the right arm and place the upper arm on top of the preacher bench or the incline bench. The dumbbell should be held at shoulder length. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("One Arm Floor Press", "Lie down on a flat surface with your back pressing against the floor or an exercise mat. Make sure your knees are bent.
...
Switch arms and repeat the movement.");
INSERT INTO Workout (title, description) VALUES ("One Arm Pronated Dumbbell Triceps Extension", "Lie flat on a bench while holding a dumbbell at arms length. Your arm should be perpendicular to your body. The palm of your hand should be facing towards your feet as a pronated grip is required to perform this exercise.
...
Switch arms and repeat the movement.");
INSERT INTO Workout (title, description) VALUES ("One Arm Supinated Dumbbell Triceps Extension", "Lie flat on a bench while holding a dumbbell at arms length. Your arm should be perpendicular to your body. The palm of your hand should be facing towards your face as a supinated grip is required to perform this exercise.
Place your non lifting hand on your bicep for support.
Slowly begin to lower the dumbbell down as you breathe in.
Then, begin lifting the dumbbell upward as you contract the triceps. Remember to breathe out during the concentric (lifting part of the exercise).
Repeat until you have performed your set repetitions.
...
INSERT INTO Workout (title, description) VALUES ("Overhead Cable Curl", "To begin, set a weight that is comfortable on each side of the pulley machine. Note: Make sure that the amount of weight selected is the same on each side.
...
INSERT INTO Workout (title, description) VALUES ("Overhead Triceps", "Sit upright on the floor with your partner behind you. Raise one arm straight up, and flex the elbow, attempting to touch your hand to your back. Your parner should hold your elbow and wrist. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Palms-Down Wrist Curls Over a Bench", "Start out by placing two dumbbells on one side of a flat bench.
...
Your forearms should be stationary as your wrist is the only movement needed to perform this exercise.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Pin Presses", "Pin presses remove the eccentric phase of the bench press, developing starting strength. They also allow you to train a desired range of motion.
...
INSERT INTO Workout (title, description) VALUES ("Preacher Curl", "To perform this movement you will need a preacher bench and an E-Z bar. Grab the E-Z curl bar at the close inner handle (either have someone hand you the bar which is preferable or grab the bar from the front bar rest provided by most preacher benches). The palm of your hands should be facing forward and they should be slightly tilted inwards due to the shape of the bar.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Push-ups - Close Triceps Position", "Lie on the floor face down and place your hands closer than shoulder width for a close hand position. Make sure that you are holding your torso up at arms' length.
...
INSERT INTO Workout (title, description) VALUES ("Reverse Barbell Curl", "Stand up with your torso upright while holding a barbell at shoulder width with the elbows close to the torso. The palm of your hands should be facing down (pronated grip). This will be your starting position.
...
Slowly begin to bring the bar back to starting position as your breathe in.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Reverse Cable Curl", "Stand up with your torso upright while holding a bar attachment that is attached to a low pulley using a pronated (palms down) and shoulder width grip. Make sure also that you keep the elbows close to the torso. This will be your starting position.
While holding the upper arms stationary, curl the weights while contracting the biceps as you breathe out. Only the forearms should move. Continue the movement until your biceps are fully contracted and the bar is at shoulder level. Hold the contracted position for a second as you squeeze the muscle.
Slowly begin to bring the bar back to starting position as your breathe in.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Reverse Grip Triceps Pushdown", "Start by setting a bar attachment (straight or e-z) on a high pulley machine.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Reverse Triceps Bench Press", "Lie back on a flat bench. Using a close, supinated grip (around shoulder width), lift the bar from the rack and hold it straight over you with your arms locked extended in front of you and perpendicular to the floor. This will be your starting position.
As you breathe in, come down slowly until you feel the bar on your middle chest. Tip: Make sure that as opposed to a regular bench press, you keep the elbows close to the torso at all times in order to maximize triceps involvement.
After a second pause, bring the bar back to the starting position as you breathe out and push the bar using your triceps muscles. Lock your arms in the contracted position, hold for a second and then start coming down slowly again. Tip: It should take at least twice as long to go down than to come up.
Repeat the movement for the prescribed amount of repetitions.
When you are done, place the bar back in the rack.");
INSERT INTO Workout (title, description) VALUES ("Seated Bent-Over One-Arm Dumbbell Triceps Extension", "Sit down at the end of a flat bench with a dumbbell in one arm using a neutral grip (palms of the hand facing you).
...
INSERT INTO Workout (title, description) VALUES ("Seated Bent-Over Two-Arm Dumbbell Triceps Extension", "Sit down at the end of a flat bench with a dumbbell in both arms using a neutral grip (palms of the hand facing you).
Bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Make sure that you keep the head up.
...
Repeat the movement for the prescribed amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Seated Biceps", "Sit on the floor with your knees bent and your partner standing behind you. Extend your arms straight behind you with your palms facing each other. Your partner will hold your wrists for you. This will be the starting position.
...
INSERT INTO Workout (title, description) VALUES ("Seated Close-Grip Concentration Barbell Curl", "Sit down on a flat bench with a barbell or E-Z Bar in front of you in between your legs. Your legs should be spread with the knees bent and the feet on the floor.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Seated Dumbbell Curl", "Sit on a flat bench with a dumbbell on each hand being held at arms length. The elbows should be close to the torso.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Seated Dumbbell Inner Biceps Curl", "Sit on the end of a flat bench with a dumbbell in each hand being held at arms length. The elbows should be close to the torso.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Seated Triceps Press", "Sit down on a bench with back support and grasp a dumbbell with both hands and hold it overhead at arm's length. Tip: a better way is to have somebody hand it to you especially if it is very heavy. The resistance should be resting in the palms of your hands with your thumbs around it. The palm of the hand should be facing inward. This will be your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Smith Machine Close-Grip Bench Press", "Place a flat bench underneath the smith machine. Place the barbell at a height that you can reach when lying down and your arms are almost fully extended. Once the weight you need is selected, lie down on the flat bench. Using a close and pronated grip (palms facing forward) that is around shoulder width, unlock the bar from the rack and hold it straight over you with your arms locked. This will be your starting position.
As you breathe in, come down slowly until you feel the bar on your middle chest. Tip: Make sure that as opposed to a regular bench press, you keep the elbows close to the torso at all times in order to maximize triceps involvement.
After a second pause, bring the bar back to the starting position as you breathe out and push the bar using your triceps muscles. Lock your arms in the contracted position, hold for a second and then start coming down slowly again. Tip: It should take at least twice as long to go down than to come up.
Repeat the movement for the prescribed amount of repetitions.
When you are done, lock the bar back in the rack.");
INSERT INTO Workout (title, description) VALUES ("Standing Bent-Over One-Arm Dumbbell Triceps Extension", "With a dumbbell in one hand and the palm facing your torso, bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Make sure that you keep the head up.
...
Repeat the movement for the prescribed amount of repetitions.
Switch arms and repeat the exercise.");
INSERT INTO Workout (title, description) VALUES ("Standing Bent-Over Two-Arm Dumbbell Triceps Extension", "With a dumbbell in each hand and the palms facing your torso, bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Make sure that you keep the head up. The upper arms should be close to the torso and parallel to the floor while the forearms are pointing towards the floor as the hands hold the weights. Tip: There should be a 90-degree angle between the forearms and the upper arm. This is your starting position.
...
Repeat the movement for the prescribed amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Standing Biceps Cable Curl", "Stand up with your torso upright while holding a cable curl bar that is attached to a low pulley. Grab the cable bar at shoulder width and keep the elbows close to the torso. The palm of your hands should be facing up (supinated grip). This will be your starting position.
While holding the upper arms stationary, curl the weights while contracting the biceps as you breathe out. Only the forearms should move. Continue the movement until your biceps are fully contracted and the bar is at shoulder level. Hold the contracted position for a second as you squeeze the muscle.
Slowly begin to bring the curl bar back to starting position as your breathe in.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Standing Concentration Curl", "Taking a dumbbell in your working hand, lean forward. Allow your working arm to hang perpendicular to the ground with the elbow pointing out. This will be your starting position.
...
Repeat the movement for the prescribed amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Standing Dumbbell Reverse Curl", "To begin, stand straight with a dumbbell in each hand using a pronated grip (palms facing down). Your arms should be fully extended while your feet are shoulder width apart from each other. This is the starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Standing Dumbbell Triceps Extension", "To begin, stand up with a dumbbell held by both hands. Your feet should be about shoulder width apart from each other. Slowly use both hands to grab the dumbbell and lift it over your head until both arms are fully extended.
...
Go back to the starting position by using the triceps to raise the dumbbell. Breathe out as you perform this step.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Standing Inner-Biceps Curl", "Stand up with a dumbbell in each hand being held at arms length. The elbows should be close to the torso. Your legs should be at about shoulder's width apart from each other.
Rotate the palms of the hands so that they are facing inward in a neutral position. This will be your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Standing One-Arm Cable Curl", "Start out by grabbing single handle next to the low pulley machine. Make sure you are far enough from the machine so that your arm is supporting the weight.
...
INSERT INTO Workout (title, description) VALUES ("Standing One-Arm Dumbbell Curl Over Incline Bench", "Stand on the back side of an incline bench as if you were going to be a spotter for someone. Have a dumbbell in one hand and rest it across the incline bench with a supinated (palms up) grip.
...
Repeat for the recommended amount of repetitions.
Switch arms while performing this exercise.");
INSERT INTO Workout (title, description) VALUES ("Standing Overhead Barbell Triceps Extension", "To begin, stand up holding a barbell or e-z bar using a pronated grip (palms facing forward) with your hands closer than shoulder width apart from each other. Your feet should be about shoulder width apart.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Tate Press", "Lie down on a flat bench with a dumbbell in each hand on top of your thighs. The palms of your hand will be facing each other.
...
Repeat the movement for the prescribed amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Tricep Plank Extension", "Assume a push-up position on the ground with a dumbbell in each hand. You should be supporting your body weight on your toes and hands keeping your torso straight. Your arms should be shoulder-width apart and fully extended. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Triceps Pushdown", "Attach a straight or angled bar to a high pulley and grab with an overhand grip (palms facing down) at shoulder width.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Zottman Curl", "Stand up with your torso upright and a dumbbell in each hand being held at arms length. The elbows should be close to the torso.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Push-ups", "The starting position is facing down with weight distributed on the hands and feet. The body is rigid and straight, and the hands are usually placed approximately shoulder width apart (the plank position).
...
INSERT INTO Workout (title, description) VALUES ("Anti-Gravity Press", "Place a bar on the ground behind the head of an incline bench.
Lay on the bench face down. With a pronated grip, pick the barbell up from the floor. Flex the elbows, performing a reverse curl to bring the bar near your chest. This will be your starting position.
To begin, press the barbell out in front of your head by extending your elbows. Keep your arms parallel to the ground throughout the movement.
Return to the starting position and repeat to complete the set.");
INSERT INTO Workout (title, description) VALUES ("Arnold Dumbbell Press", "Sit on an exercise bench with back support and hold two dumbbells in front of you at about upper chest level with your palms facing your body and your elbows bent. Tip: Your arms should be next to your torso. The starting position should look like the contracted portion of a dumbbell curl.
Now to perform the movement, raise the dumbbells as you rotate the palms of your hands until they are facing forward.
Continue lifting the dumbbells until your arms are extended above you in straight arm position. Breathe out as you perform this portion of the movement.
After a second pause at the top, begin to lower the dumbbells to the original position by rotating the palms of your hands towards you. Tip: The left arm will be rotated in a counter clockwise manner while the right one will be rotated clockwise. Breathe in as you perform this portion of the movement.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Around the Worlds", "Lay down on a flat bench holding a dumbbell in each hand with the palms of the hands facing towards the ceiling. Tip: Your arms should be parallel to the floor and next to your thighs. To avoid injury, make sure that you keep your elbows slightly bent. This will be your starting position.
Now move the dumbbells by creating a semi-circle as you displace them from the initial position to over the head. All of the movement should happen with the arms parallel to the floor at all times. Breathe in as you perform this portion of the movement.
Reverse the movement to return the weight to the starting position as you exhale.");
INSERT INTO Workout (title, description) VALUES ("Axle Clean and Press", "Assume a shoulder-width stance, with knees inside the arms.
...
INSERT INTO Workout (title, description) VALUES ("Barbell Bench Press", "Lie back on a flat bench. Using a medium width grip (a grip that creates a 90-degree angle in the middle of the movement between the forearms and the upper arms), lift the bar from the rack and hold it straight over you with your arms locked. This will be your starting position.
From the starting position, breathe in and begin coming down slowly until the bar touches your middle chest.
After a brief pause, push the bar back to the starting position as you breathe out. Focus on pushing the bar using your chest muscles. Lock your arms and squeeze your chest in the contracted position at the top of the motion, hold for a second and then start coming down slowly again. Tip: Ideally, lowering the weight should take about twice as long as raising it.
Repeat the movement for the prescribed amount of repetitions.
When you are done, place the bar back in the rack.");
INSERT INTO Workout (title, description) VALUES ("Barbell Deadlift", "Approach the bar so that it is centered over your feet. Your feet should be about hip-width apart. Bend at the hip to grip the bar at shoulder-width allowing your shoulder blades to protract. Typically, you would use an alternating grip.
With your feet and your grip set, take a big breath and then lower your hips and flex the knees until your shins contact the bar. Look forward with your head. Keep your chest up and your back arched, and begin driving through the heels to move the weight upward.
After the bar passes the knees aggressively pull the bar back, pulling your shoulder blades together as you drive your hips forward into the bar.
Lower the bar by bending at the hips and guiding it to the floor.");
INSERT INTO Workout (title, description) VALUES ("Barbell Front Raise", "Adopt a pronated, shoulder-width grip on the barbell from a standing position.
...
INSERT INTO Workout (title, description) VALUES ("Barbell Full Squat", "This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack just above shoulder level. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Barbell Glute Bridge", "Begin seated on the ground with a loaded barbell over your legs. Using a fat bar or having a pad on the bar can greatly reduce the discomfort caused by this exercise. Roll the bar so that it is directly above your hips, and lay down flat on the floor.
Begin the movement by driving through with your heels, extending your hips vertically through the bar. Your weight should be supported by your upper back and the heels of your feet.
Extend as far as possible, then reverse the motion to return to the starting position.");
INSERT INTO Workout (title, description) VALUES ("Barbell Hip Thrust", "Begin seated on the ground with a bench directly behind you. Have a loaded barbell over your legs. Using a fat bar or having a pad on the bar can greatly reduce the discomfort caused by this exercise.
Roll the bar so that it is directly above your hips, and lean back against the bench so that your shoulder blades are near the top of it.
Begin the movement by driving through your feet, extending your hips vertically through the bar. Your weight should be supported by your shoulder blades and your feet. Extend as far as possible, then reverse the motion to return to the starting position.");
INSERT INTO Workout (title, description) VALUES ("Barbell Lunge", "This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack just below shoulder level. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
Hold on to the bar using both arms at each side and lift it off the rack by first pushing with your legs and at the same time straightening your torso.
...
INSERT INTO Workout (title, description) VALUES ("Barbell Rear Delt Row", "Stand up straight while holding a barbell using a wide (higher than shoulder width) and overhand (palms facing your body) grip.
...
INSERT INTO Workout (title, description) VALUES ("Barbell Seated Calf Raise", "Place a block about 12 inches in front of a flat bench.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Barbell Shoulder Press", "Sit on a bench with back support in a squat rack. Position a barbell at a height that is just above your head. Grab the barbell with a pronated grip (palms facing forward).
Once you pick up the barbell with the correct grip width, lift the bar up over your head by locking your arms. Hold at about shoulder level and slightly in front of your head. This is your starting position.
Lower the bar down to the shoulders slowly as you inhale.
Lift the bar back up to the starting position as you exhale.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Barbell Shrug", "Stand up straight with your feet at shoulder width as you hold a barbell with both hands in front of you using a pronated grip (palms facing the thighs). Tip: Your hands should be a little wider than shoulder width apart. You can use wrist wraps for this exercise for a better grip. This will be your starting position.
...
Repeat for the recommended amount of repetitions.
");
INSERT INTO Workout (title, description) VALUES ("Barbell Side Split Squat", "Stand up straight while holding a barbell placed on the back of your shoulders (slightly below the neck). Your feet should be placed wide apart with the foot of the lead leg angled out to the side. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Barbell Squat", "Begin with the barbell supported on top of the traps. The chest should be up and the head facing forward. Adopt a hip-width stance with the feet turned out as needed.
...
INSERT INTO Workout (title, description) VALUES ("Barbell Step Ups", "Stand up straight while holding a barbell placed on the back of your shoulders (slightly below the neck) and stand upright behind an elevated platform (such as the one used for spotting behind a flat bench). This is your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Barbell Walking Lunge", "Begin standing with your feet shoulder width apart and a barbell across your upper back.
Step forward with one leg, flexing the knees to drop your hips. Descend until your rear knee nearly touches the ground. Your posture should remain upright, and your front knee should stay above the front foot.
Drive through the heel of your lead foot and extend both knees to raise yourself back up.
Step forward with your rear foot, repeating the lunge on the opposite leg.");
INSERT INTO Workout (title, description) VALUES ("Bench Jump", "Begin with a box or bench 1-2 feet in front of you. Stand with your feet shoulder width apart. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Bent Over Barbell Row", "Holding a barbell with a pronated grip (palms facing down), bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Tip: Make sure that you keep the head up. The barbell should hang directly in front of you as your arms hang perpendicular to the floor and your torso. This is your starting position.
Now, while keeping the torso stationary, breathe out and lift the barbell to you. Keep the elbows close to the body and only use the forearms to hold the weight. At the top contracted position, squeeze the back muscles and hold for a brief pause.
Then inhale and slowly lower the barbell back to the starting position.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Bent Over Two-Dumbbell Row", "With a dumbbell in each hand (palms facing your torso), bend your knees slightly and bring your torso forward by bending at the waist; as you bend make sure to keep your back straight until it is almost parallel to the floor. Tip: Make sure that you keep the head up. The weights should hang directly in front of you as your arms hang perpendicular to the floor and your torso. This is your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Bent-Arm Barbell Pullover", "Lie on a flat bench with a barbell using a shoulder grip width.
...
INSERT INTO Workout (title, description) VALUES ("Bent-Arm Dumbbell Pullover", "Place a dumbbell standing up on a flat bench.
...
Hold the weight on the initial position for a second and repeat the motion for the prescribed number of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Bicycling, Stationary", "To begin, seat yourself on the bike and adjust the seat to your height.
Select the desired option from the menu. You may have to start pedaling to turn it on. You can use the manual setting, or you can select a program to use. Typically, you can enter your age and weight to estimate the amount of calories burned during exercise. The level of resistance can be changed throughout the workout. The handles can be used to monitor your heart rate to help you stay at an appropriate intensity.");
INSERT INTO Workout (title, description) VALUES ("Bodyweight Lunge", "Stand erect with your feet hip-width apart, chest out, and shoulders back, maintaining the natural curvature of your spine. Your knees should be unlocked and your hand on your hips. This is your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Bodyweight Reverse Lunge", "Begin in a standing position. Your hands should be on your hips or hanging at your sides. Look directly forward, keeping your chest up, with your feet shoulder-width apart. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Bodyweight Squat", "Stand with your feet shoulder width apart. You can place your hands behind your head. This will be your starting position.
Begin the movement by flexing your knees and hips, sitting back with your hips.
Continue down to full depth if you are able,and quickly reverse the motion until you return to the starting position. As you squat, keep your head and chest up and push your knees out.");
INSERT INTO Workout (title, description) VALUES ("Bodyweight Walking Lunge", "Begin standing with your feet shoulder width apart and your hands on your hips.
Step forward with one leg, flexing the knees to drop your hips. Descend until your rear knee nearly touches the ground. Your posture should remain upright, and your front knee should stay above the front foot.
Drive through the heel of your lead foot and extend both knees to raise yourself back up.
Step forward with your rear foot, repeating the lunge on the opposite leg.");
INSERT INTO Workout (title, description) VALUES ("Box Squat", "The box squat allows you to squat to desired depth and develop explosive strength in the squat movement. Begin in a power rack with a box at the appropriate height behind you. Typically, you would aim for a box height that brings you to a parallel squat, but you can train higher or lower if desired.
...
INSERT INTO Workout (title, description) VALUES ("Burpee", "Begin standing with your legs shoulder-width apart.
...
Repeat.");
INSERT INTO Workout (title, description) VALUES ("Butt Kicks", "Stand with your legs shoulder-width apart. Your arms should be bent at your sides.
...
Repeat");
INSERT INTO Workout (title, description) VALUES ("Butt Lift (Bridge)", "Lie flat on the floor on your back with the hands by your side and your knees bent. Your feet should be placed around shoulder width. This will be your starting position.
Pushing mainly with your heels, lift your hips off the floor while keeping your back straight. Breathe out as you perform this part of the motion and hold at the top for a second.
Slowly go back to the starting position as you breathe in.");
INSERT INTO Workout (title, description) VALUES ("Butterfly", "Sit on the machine with your back flat on the pad.
...
INSERT INTO Workout (title, description) VALUES ("Cable Crossover", "To get yourself into the starting position, place the pulleys on a high position (above your head), select the resistance to be used and hold the pulleys in each hand.
...
INSERT INTO Workout (title, description) VALUES ("Cable Deadlifts", "Move the cables to the bottom of the towers and select an appropriate weight. Stand directly in between the uprights.
...
INSERT INTO Workout (title, description) VALUES ("Cable Hip Adduction", "Stand in front of a low pulley facing forward with one leg next to the pulley and the other one away.
...
INSERT INTO Workout (title, description) VALUES ("Cable Iron Cross", "Begin by moving the pulleys to the high position, select the resistance to be used, and take a handle in each hand.
...
INSERT INTO Workout (title, description) VALUES ("Cable Rear Delt Fly", "Adjust the pulleys to the appropriate height and adjust the weight. The pulleys should be above your head.
...
INSERT INTO Workout (title, description) VALUES ("Cable Shoulder Press", "Move the cables to the bottom of the towers and select an appropriate weight.
...
INSERT INTO Workout (title, description) VALUES ("Cable Shrugs", "Grasp a cable bar attachment that is attached to a low pulley with a shoulder width or slightly wider overhand (palms facing down) grip.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Calf Press", "Adjust the seat so that your legs are only slightly bent in the start position. The balls of your feet should be firmly on the platform.
...
INSERT INTO Workout (title, description) VALUES ("Car Drivers", "While standing upright, hold a barbell plate in both hands at the 3 and 9 o'clock positions. Your palms should be facing each other and your arms should be extended straight out in front of you. This will be your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Chin-Up", "Grab the pull-up bar with the palms facing your torso and a grip closer than the shoulder width.
...
INSERT INTO Workout (title, description) VALUES ("Clean", "With a barbell on the floor close to the shins, take an overhand (or hook) grip just outside the legs. Lower your hips with the weight focused on the heels, back straight, head facing forward, chest up, with your shoulders just in front of the bar. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Clean and Jerk", "With a barbell on the floor close to the shins, take an overhand or hook grip just outside the legs. Lower your hips with the weight focused on the heels, back straight, head facing forward, chest up, with your shoulders just in front of the bar. This will be your starting position.
Begin the first pull by driving through the heels, extending your knees. Your back angle should stay the same, and your arms should remain straight. Move the weight with control as you continue to above the knees.
Next comes the second pull, the main source of acceleration for the clean. As the bar approaches the mid-thigh position, begin extending through the hips. In a jumping motion, accelerate by extending the hips, knees, and ankles, using speed to move the bar upward. There should be no need to actively pull through the arms to accelerate the weight; at the end of the second pull, the body should be fully extended, leaning slightly back, with the arms still extended.
As full extension is achieved, transition into the third pull by aggressively shrugging and flexing the arms with the elbows up and out. At peak extension, aggressively pull yourself down, rotating your elbows under the bar as you do so. Receive the bar in a front squat position, the depth of which is dependent upon the height of the bar at the end of the third pull. The bar should be racked onto the protracted shoulders, lightly touching the throat with the hands relaxed. Continue to descend to the bottom squat position, which will help in the recovery.
Immediately recover by driving through the heels, keeping the torso upright and elbows up. Continue until you have risen to a standing position.
...
INSERT INTO Workout (title, description) VALUES ("Clean and Press", "Assume a shoulder-width stance, with knees inside the arms. Now while keeping the back flat, bend at the knees and hips so that you can grab the bar with the arms fully extended and a pronated grip that is slightly wider than shoulder width. Point the elbows out to sides. The bar should be close to the shins. Position the shoulders over or slightly ahead of the bar. Establish a flat back posture. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Clean Pull", "With a barbell on the floor close to the shins, take an overhand or hook grip just outside the legs. Lower your hips with the weight focused on the heels, back straight, head facing forward, chest up, with your shoulders just in front of the bar. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Clean Shrug", "Begin with a shoulder width, double overhand or hook grip, with the bar hanging at the mid thigh position. Your back should be straight and inclined slightly forward.
...
INSERT INTO Workout (title, description) VALUES ("Clock Push-Up", "Move into a prone position on the floor, supporting your weight on your hands and toes.
...
INSERT INTO Workout (title, description) VALUES ("Front Lat Pulldown", "Sit down on a pull-down machine with a wide bar attached to the top pulley. Make sure that you adjust the knee pad of the machine to fit your height. These pads will prevent your body from being raised by the resistance attached to the bar.
...
Repeat this motion for the prescribed amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Close-Hands Push-Up", "Get in the push-up position on your toes with your hands directly under your shoulders. Your body should be as straight as possible, maintaining the neutral alignment of your head. This is your start position.
...
INSERT INTO Workout (title, description) VALUES ("Crossover Reverse Lunge", "Stand with your feet shoulder width apart. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Cuban Press", "Take a dumbbell in each hand with a pronated grip in a standing position. Raise your upper arms so that they are parallel to the floor, allowing your lower arms to hang in the ""scarecrow"" position. This will be your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Defensive Slide", "Begin in an athletic position with your knees bent and your chest up. Your arms should be in front of your body.
...
Repeat.");
INSERT INTO Workout (title, description) VALUES ("Diamond Push-Up", "Get in the modified push-up position on your knees but with your hands together and back flat. Spread your fingers so that your index fingers and thumbs form a diamond, and extend your arms. This is your start position.
...
INSERT INTO Workout (title, description) VALUES ("Double Leg Butt Kick", "Begin standing with your knees slightly bent.
...
INSERT INTO Workout (title, description) VALUES ("Dumbbell Bench Press", "Lie down on a flat bench with a dumbbell in each hand resting on top of your thighs. The palms of your hands will be facing each other.
...
Repeat the movement for the prescribed amount of repetitions of your training program.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell Flyes", "Lie down on a flat bench with a dumbbell on each hand resting on top of your thighs. The palms of your hand will be facing each other.
...
INSERT INTO Workout (title, description) VALUES ("Dumbbell Lunges", "Stand with your torso upright holding two dumbbells in your hands by your sides. This will be your starting position.
...
Using mainly the heel of your foot, push up and go back to the starting position as you exhale.
Repeat the movement for the recommended amount of repetitions and then perform with the left leg.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell Lying Rear Lateral Raise", "While holding a dumbbell in each hand, lay with your chest down on a slightly inclined (around 15 degrees when measured from the floor) adjustable bench.
...
Repeat for the recommended amount of repetitions and then switch to the other arm.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell One-Arm Shoulder Press", "Grab a dumbbell and either sit on a military press bench or a utility bench that has a back support on it as you place the dumbbells upright on top of your thighs or stand up straight.
...
INSERT INTO Workout (title, description) VALUES ("Dumbbell One-Arm Upright Row", "Grab a dumbbell and stand up straight with your arm extended in front of you with a slight bend at the elbows and your back straight. This will be your starting position. Tip: The dumbbell should be resting on top of your thigh with the palm of your hands facing your thighs.
...
Repeat for the recommended amount of repetitions and switch arms.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell Raise", "Grab a dumbbell in each arm and stand up straight with your arms extended by your sides with a slight bend at the elbows and your back straight. This will be your starting position. Tip: The dumbbell should be next to your thighs with the palm of your hands facing back.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell Seated One-Leg Calf Raise", "Place a block on the floor about 12 inches from a flat bench.
...
INSERT INTO Workout (title, description) VALUES ("Dumbbell Shoulder Press", "While holding a dumbbell in each hand, sit on a military press bench or utility bench that has back support. Place the dumbbells upright on top of your thighs.
Now raise the dumbbells to shoulder height one at a time using your thighs to help propel them up into position.
Make sure to rotate your wrists so that the palms of your hands are facing forward. This is your starting position.
Now, exhale and push the dumbbells upward until they touch at the top.
Then, after a brief pause at the top contracted position, slowly lower the weights back down to the starting position while inhaling.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell Shrug", "Stand erect with a dumbbell on each hand (palms facing your torso), arms extended on the sides.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell Side Lunge", "Stand erect with your feet about shoulder-width apart holding a pair of light-weight dumbbells together in front of you, palms facing in. Your chest should be out, shoulders back, and knees unlocked. Maintain the natural curvature in your back. This is your start position.
...
INSERT INTO Workout (title, description) VALUES ("Dumbbell Squat", "Stand up straight while holding a dumbbell on each hand (palms facing the side of your legs).
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Dumbbell Step Ups", "Stand up straight while holding a dumbbell on each hand (palms facing the side of your legs).
Place the right foot on the elevated platform. Step on the platform by extending the hip and the knee of your right leg. Use the heel mainly to lift the rest of your body up and place the foot of the left leg on the platform as well. Breathe out as you execute the force required to come up.
Step down with the left leg by flexing the hip and knee of the right leg as you inhale. Return to the original standing position by placing the right foot of to next to the left foot on the initial position.
Repeat with the right leg for the recommended amount of repetitions and then perform with the left leg.");
INSERT INTO Workout (title, description) VALUES ("Elliptical Trainer", "To begin, step onto the elliptical and select the desired option from the menu. Most ellipticals have a manual setting, or you can select a program to run. Typically, you can enter your age and weight to estimate the amount of calories burned during exercise. Elevation can be adjusted to change the intensity of the workout.
The handles can be used to monitor your heart rate to help you stay at an appropriate intensity.");
INSERT INTO Workout (title, description) VALUES ("External Rotation", "Lie sideways on a flat bench with one arm holding a dumbbell and the other hand on top of the bench folded so that you can rest your head on it.
...
As you breathe in, slowly go back to the starting position.
Repeat for the recommended amount of repetitions and then switch to the other arm.");
INSERT INTO Workout (title, description) VALUES ("Fast Skipping", "Start in a relaxed position with one leg slightly forward. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Feet Jack", "Start with your feet together, arms bent, and elbows at your side.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Flutter Kicks", "On a flat bench lie facedown with the hips on the edge of the bench, the legs straight with toes high off the floor and with the arms on top of the bench holding on to the front edge.
...
INSERT INTO Workout (title, description) VALUES ("Football Up-Down", "Start with your feet shoulder-width apart and arms bent at your sides.
...
INSERT INTO Workout (title, description) VALUES ("Frog Hops", "Stand with your hands behind your head, and squat down keeping your torso upright and your head up. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Front Barbell Squat", "This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, bring your arms up under the bar while keeping the elbows high and the upper arm slightly above parallel to the floor. Rest the bar on top of the deltoids and cross your arms while grasping the bar for total control.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Front Cable Raise", "Select the weight on a low pulley machine and grasp the single hand cable attachment that is attached to the low pulley with your left hand.
...
INSERT INTO Workout (title, description) VALUES ("Front Dumbbell Raise", "Pick a couple of dumbbells and stand with a straight torso and the dumbbells on front of your thighs at arms length with the palms of the hand facing your thighs. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Front Leg Raises", "Stand next to a chair or other support, holding on with one hand.
...
INSERT INTO Workout (title, description) VALUES ("Front Two-Dumbbell Raise", "Pick a couple of dumbbells and stand with a straight torso and the dumbbells on front of your thighs at arms length with the palms of the hand facing your thighs. This will be your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Glute Kickback", "Kneel on the floor or an exercise mat and bend at the waist with your arms extended in front of you (perpendicular to the torso) in order to get into a kneeling push-up position but with the arms spaced at shoulder width. Your head should be looking forward and the bend of the knees should create a 90-degree angle between the hamstrings and the calves. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Hand Stand Push-Ups", "With your back to the wall bend at the waist and place both hands on the floor at shoulder width.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Hang Clean", "Begin with a shoulder width, double overhand or hook grip, with the bar hanging at the mid thigh position. Your back should be straight and inclined slightly forward.
...
Immediately recover by driving through the heels, keeping the torso upright and elbows up. Continue until you have risen to a standing position.");
INSERT INTO Workout (title, description) VALUES ("Hang Snatch", "Begin with a wide grip on the bar, with an overhand or hook grip. The feet should be directly below the hips with the feet turned out. Your knees should be slightly bent, and the torso inclined forward. The spine should be fully extended and the head facing forward. The bar should be at the hips. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Hanging Bar Good Morning", "Begin with a bar on a rack at about the same height as your stomach. Suspend the bar using chains or suspension straps.
...
INSERT INTO Workout (title, description) VALUES ("High Knee Jog", "Begin in an athletic position with your knees bent, your feet shoulder-width apart, and your arms bent and at your sides.
...
INSERT INTO Workout (title, description) VALUES ("Hyperextensions", "Lie face down on a hyperextension bench, tucking your ankles securely under the footpads.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Ice Skater", "Begin in a standing position with your feet shoulder-width apart. You should be looking directly forward, with your chest up, knees and hips unlocked, and your back straight. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Inchworm", "Stand with your feet close together. Keeping your legs straight, stretch down and put your hands on the floor directly in front of you. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Inverted Row", "Position a bar in a rack to about waist height. You can also use a smith machine.
...
INSERT INTO Workout (title, description) VALUES ("Iron Cross", "Stand with feet shoulder width apart holding a dumbbell in each hand.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Isometric Wipers", "Assume a push-up position, supporting your weight on your hands and toes while keeping your body straight. Your hands should be just outside of shoulder width. This will be your starting position.
...
Repeat for the desired number of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Jog in Place", "Begin standing with your feet shoulder-width apart. Your arms should be bent and at your sides.
...
Repeat for the recommended amount of repetitions or time.");
INSERT INTO Workout (title, description) VALUES ("Jogging - Treadmill", "To begin, step onto the treadmill and select the desired option from the menu. Most treadmills have a manual setting, or you can select a program to run. Typically, you can enter your age and weight to estimate the amount of calories burned during exercise. Elevation can be adjusted to change the intensity of the workout.");
INSERT INTO Workout (title, description) VALUES ("Jump Squat", "Start with your arms by your side, feet shoulder width apart, head up, and back straight.
...
INSERT INTO Workout (title, description) VALUES ("Jumping Jacks", "Start by standing with your feet together. In one motion, jump your feet out to the side and raise your arms above your head.
Immediately reverse the motion by jumping back to the starting position.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Knee Tuck Jump", "Begin in a comfortable standing position with your knees slightly bent. Hold your hands in front of you, palms down with your fingertips together at chest height. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Leg Extensions", "For this exercise you will need to use a leg extension machine. First choose your weight and sit on the machine with your legs under the pad (feet pointed forward) and the hands holding the side bars. This will be your starting position. Tip: You will need to adjust the pad so that it falls on top of your lower leg (just above your feet). Also, make sure that your legs form a 90-degree angle between the lower and upper leg. If the angle is less than 90-degrees then that means the knee is over the toes which in turn creates undue stress at the knee joint. If the machine is designed that way, either look for another machine or just make sure that when you start executing the exercise you stop going down once you hit the 90-degree angle.
...
INSERT INTO Workout (title, description) VALUES ("Leg Lift", "While standing up straight with both feet next to each other at around shoulder width, grab a sturdy surface such as the sides of a squat rack or the top of a chair to brace yourself and keep balance.
...
INSERT INTO Workout (title, description) VALUES ("Leg Press", "Using a leg press machine, sit down on the machine and place your legs on the platform directly in front of you at a medium (shoulder width) foot stance. (Note: For the purposes of this discussion we will use the medium stance described above which targets overall development; however you can choose any of the three stances described in the foot positioning section).
...
INSERT INTO Workout (title, description) VALUES ("Low Cable Crossover", "To move into the starting position, place the pulleys at the low position, select the resistance to be used and grasp a handle in each hand.
...
INSERT INTO Workout (title, description) VALUES ("Low Pulley Row to Neck", "Sit on a low pulley row machine with a rope attachment.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Lunge Sprint", "Adjust a bar in a Smith machine to an appropriate height. Position yourself under the bar, racking it across the back of your shoulders. Unrack the bar, and then split your feet, moving one foot forward and one foot back. This will be your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Lying Cambered Barbell Row", "Place a cambered bar underneath an exercise bench.
...
INSERT INTO Workout (title, description) VALUES ("Lying Leg Curls", "Adjust the machine lever to fit your height and lie face down on the leg curl machine with the pad of the lever on the back of your legs (just a few inches under the calves). Tip: Preferably use a leg curl machine that is angled as opposed to flat since an angled position is more favorable for hamstrings recruitment.
...
INSERT INTO Workout (title, description) VALUES ("Lying Machine Squat", "Adjust the leg machine to a height that will allow you to get inside it with your knees bent and the thighs slightly below parallel.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Lying One-Arm Lateral Raise", "While holding a dumbbell in one hand, lay with your chest down on a flat bench. The other hand can be used to hold to the leg of the bench for stability.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Lying Rear Delt Raise", "While holding a dumbbell in each hand, lay with your chest down on a flat bench.
Position the palms of the hands in a neutral manner (palms facing your torso) as you keep the arms extended with the elbows slightly bent. This will be your starting position.
Now raise the arms to the side until your elbows are at shoulder height and your arms are roughly parallel to the floor as you exhale. Tip: Maintain your arms perpendicular to the torso while keeping them extended throughout the movement. Also, keep the contraction at the top for a second.
Slowly lower the dumbbells to the starting position as you inhale.
Repeat for the recommended amount of repetitions and then switch to the other arm.");
INSERT INTO Workout (title, description) VALUES ("Machine Bench Press", "Sit down on the Chest Press Machine and select the weight.
...
INSERT INTO Workout (title, description) VALUES ("Machine Lateral Raise", "Adjust the machine and select an appropriate load. Seat yourself facing the machine with the base of your upper arm against the pad.
...
INSERT INTO Workout (title, description) VALUES ("Machine Shoulder Press", "Sit down on the Shoulder Press Machine and select the weight.
...
Lower the handles slowly back to the starting position as you inhale.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Machine Squat", "Adjust the weight to an appropriate load for your training.
...
INSERT INTO Workout (title, description) VALUES ("Man Maker", "Position a pair of light-weight dumbbells in front of you, parallel to each other. Keeping your back flat, bend forward and squat down, grasping the dumbbells. This is your start position.
...
INSERT INTO Workout (title, description) VALUES ("Middle Back Shrug", "Lie facedown on an incline bench while holding a dumbbell in each hand. Your arms should be fully extended hanging down and pointing towards the floor. The palms of your hands should be facing each other. This will be your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Mountain Climbers", "Begin in a pushup position, with your weight supported by your hands and toes. Flexing the knee and hip, bring one leg until the knee is approximately under the hip. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Muscle Snatch", "Begin with a loaded barbell held at the mid thigh position with a wide grip. The feet should be directly below the hips, with the feet turned out as needed. Lower the hips, with the chest up and the head looking forward. The shoulders should be just in front of the bar. This will be the starting position.
...
INSERT INTO Workout (title, description) VALUES ("Natural Glute Ham Raise", "Using the leg pad of a lat pulldown machine or a preacher bench, position yourself so that your ankles are under the pads, knees on the seat, and you are facing away from the machine. You should be upright and maintaining good posture.
...
INSERT INTO Workout (title, description) VALUES ("One Leg Barbell Squat", "Start by standing about 2 to 3 feet in front of a flat bench with your back facing the bench. Have a barbell in front of you on the floor. Tip: Your feet should be shoulder width apart from each other.
...
INSERT INTO Workout (title, description) VALUES ("One-Arm Dumbbell Row", "Choose a flat bench and place a dumbbell on each side of it.
...
INSERT INTO Workout (title, description) VALUES ("Pelvic Tilt Into Bridge", "Lie down with your feet on the floor, heels directly under your knees.
...
INSERT INTO Workout (title, description) VALUES ("Plate Row", "Stack the needed number of plates on top of a small plate on the ground, allowing you to easily grip the rims.
...
INSERT INTO Workout (title, description) VALUES ("Power Partials", "Stand up with your torso upright and a dumbbell on each hand being held at arms length. The elbows should be close to the torso.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Pull Through", "Begin standing a few feet in front of a low pulley with a rope or handle attached. Face away from the machine, straddling the cable, with your feet set wide apart.
...
INSERT INTO Workout (title, description) VALUES ("Pullups", "Grab the pull-up bar with the palms facing forward using the prescribed grip. Note on grips: For a wide grip, your hands need to be spaced out at a distance wider than your shoulder width. For a medium grip, your hands need to be spaced out at a distance equal to your shoulder width and for a close grip at a distance smaller than your shoulder width.
...
Repeat this motion for the prescribed amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Push Press", "Upward Movement Phase:
...
INSERT INTO Workout (title, description) VALUES ("Push-Up to Side Plank", "Get into pushup position on the toes with your hands just outside of shoulder width.
...
INSERT INTO Workout (title, description) VALUES ("Push-Up Wide", "With your hands wide apart, support your body on your toes and hands in a plank position. Your elbows should be extended and your body straight. Do not allow your hips to sag. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Push-Ups With Feet Elevated", "Lie on the floor face down and place your hands about 36 inches apart from each other holding your torso up at arms length.
...
After a second pause at the contracted position, repeat the movement for the prescribed amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Rack Pulls", "Set up in a power rack with the bar on the pins. The pins should be set to the desired point; just below the knees, just above, or in the mid thigh position. Position yourself against the bar in proper deadlifting position. Your feet should be under your hips, your grip shoulder width, back arched, and hips back to engage the hamstrings. Since the weight is typically heavy, you may use a mixed grip, a hook grip, or use straps to aid in holding the weight.
...
INSERT INTO Workout (title, description) VALUES ("Rear Leg Raises", "Place yourself on your hands knees on an exercise mat. Your head should be looking forward and the bend of the knees should create a 90-degree angle between the hamstrings and the calves. This will be your starting position.
Extend one leg up and behind you. The knee and hip should both extend. Repeat for 5-10 repetitions, and then switch sides.");
INSERT INTO Workout (title, description) VALUES ("Recumbent Bike", "To begin, seat yourself on the bike and adjust the seat to your height.
Select the desired option from the menu. You may have to start pedaling to turn it on. You can use the manual setting, or you can select a program to use. Typically, you can enter your age and weight to estimate the amount of calories burned during exercise. The level of resistance can be changed throughout the workout. The handles can be used to monitor your heart rate to help you stay at an appropriate intensity.");
INSERT INTO Workout (title, description) VALUES ("Reverse Flyes", "To begin, lie down on an incline bench with the chest and stomach pressing against the incline. Have the dumbbells in each hand with the palms facing each other (neutral grip).
...
INSERT INTO Workout (title, description) VALUES ("Rocket Jump", "Begin in a relaxed stance with your feet shoulder width apart and hold your arms close to the body.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Romanian Deadlift", "Hold a bar at hip level with a pronated (palms facing down) grip. Your shoulders should be back, your back arched, and your knees slightly bent. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Running, Treadmill", "To begin, step onto the treadmill and select the desired option from the menu. Most treadmills have a manual setting, or you can select a program to run. Typically, you can enter your age and weight to estimate the amount of calories burned during exercise. Elevation can be adjusted to change the intensity of the workout.
...
INSERT INTO Workout (title, description) VALUES ("Scissors Jump", "Assume a lunge stance position with one foot forward with the knee bent, and the rear knee nearly touching the ground.
...
INSERT INTO Workout (title, description) VALUES ("Seated Barbell Military Press", "Sit on a Military Press Bench with a bar behind your head and either have a spotter give you the bar (better on the rotator cuff this way) or pick it up yourself carefully with a pronated grip (palms facing forward). Tip: Your grip should be wider than shoulder width and it should create a 90-degree angle between the forearm and the upper arm as the barbell goes down.
...
Lift the bar back up to the starting position as you exhale.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Seated Cable Rows", "For this exercise you will need access to a low pulley row machine with a V-bar. Note: The V-bar will enable you to have a neutral grip where the palms of your hands face each other. To get into the starting position, first sit down on the machine and place your feet on the front platform or crossbar provided making sure that your knees are slightly bent and not locked.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Seated Cable Shoulder Press", "Adjust the weight to an appropriate amount and be seated, grasping the handles. Your upper arms should be about 90 degrees to the body, with your head and chest up. The elbows should also be bent to about 90 degrees. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Seated Calf Raise", "Sit on the machine and place your toes on the lower portion of the platform provided with the heels extending off. Choose the toe positioning of your choice (forward, in, or out) as per the beginning of this chapter.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Seated Dumbbell Press", "Grab a couple of dumbbells and sit on a military press bench or a utility bench that has a back support on it as you place the dumbbells upright on top of your thighs.
...
After a second pause, slowly come down back to the starting position as you inhale.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Seated Good Mornings", "Set up a box in a power rack. The pins should be set at an appropriate height. Begin by stepping under the bar and placing it across the back of the shoulders, not on top of your traps. Squeeze your shoulder blades together and rotate your elbows forward, attempting to bend the bar across your shoulders.
...
INSERT INTO Workout (title, description) VALUES ("Seated Leg Curl", "Adjust the machine lever to fit your height and sit on the machine with your back against the back support pad.
...
Slowly return to the starting position as you breathe in.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Seated Leg Press", "Adjust the bottom position of the machine and seat yourself.
...
INSERT INTO Workout (title, description) VALUES ("Shotgun Row", "Attach a single handle to a low cable.
...
INSERT INTO Workout (title, description) VALUES ("Side Lateral Raise", "Pick a couple of dumbbells and stand with a straight torso and the dumbbells by your side at arms length with the palms of the hand facing you. This will be your starting position.
While maintaining the torso in a stationary position (no swinging), lift the dumbbells to your side with a slight bend on the elbow and the hands slightly tilted forward as if pouring water in a glass. Continue to go up until you arms are parallel to the floor. Exhale as you execute this movement and pause for a second at the top.
Lower the dumbbells back down slowly to the starting position as you inhale.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Side Lateral to Front Raise", "In a standing position, hold a pair of dumbbells at your side. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Side Lunge", "Assume an athletic standing position, with the knees and hips slightly bent, feet shoulder-width apart, and the head and chest up. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Sit Squats", "Stand with your feet shoulder width apart. This will be your starting position.
Begin the movement by flexing your knees and hips, sitting back with your hips.
...
INSERT INTO Workout (title, description) VALUES ("Slow Jog", "Begin standing with your feet shoulder-width apart. Your arms should be bent and at your sides.
Lift your right knee up until it reaches your waist. Your left arm should swing forward while your right arm swings back. Keep your left knee slightly bent and allow it to spring.
...
Repeat the movement for the prescribed amount of repetitions.
When you are done, lock the bar back in the rack.");
INSERT INTO Workout (title, description) VALUES ("Smith Machine Bent Over Row", "Set the barbell attached to the smith machine to a height that is about 2 inches below your knees.
...
Slowly lower the weight again to the starting position as you inhale.
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Smith Machine Calf Raise", "Place a block or weight plate below the bar on the Smith machine. Set the bar to a position that best matches your height. Once the correct height is chosen and the bar is loaded, step onto the plates with the balls of your feet and place the bar on the back of your shoulders.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Smith Machine Leg Press", "Position a Smith machine bar a couple feet off of the ground. Ensure that it is resting on the safeties. After loading the bar to an appropriate weight, lie underneath the bar. Place the middle of your feet on the bar, tucking your knees to your chest. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Smith Machine Shrug", "To begin, set the bar height on the smith machine around the middle of your thighs. Once the correct height is chosen and the bar is loaded, grab the bar using a pronated grip (palms facing you) shoulder width apart from each other.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Smith Machine Squat", "To begin, first set the bar on the height that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Square Hop", "Begin in an athletic position with your knees bent, your feet shoulder-width apart, and your arms bent and at your sides.
...
INSERT INTO Workout (title, description) VALUES ("Standing Barbell Calf Raise", "This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the bar on the back of your shoulders (slightly below the neck).
Hold on to the bar using both arms at each side and lift it off the rack by first pushing with your legs and at the same time straightening your torso.
...
Repeat for the recommended amount of times.");
INSERT INTO Workout (title, description) VALUES ("Standing Dumbbell Press", "Standing with your feet shoulder width apart, take a dumbbell in each hand. Raise the dumbbells to head height, the elbows out and about 90 degrees. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Standing Dumbbell Upright Row", "Grasp a dumbbell in each hand with a pronated (palms forward) grip that is slightly less than shoulder width. The dumbbells should be resting on top of your thighs. Your arms should be extended with a slight bend at the elbows and your back should be straight. This will be your starting position.
...
INSERT INTO Workout (title, description) VALUES ("Standing Military Press", "Start by placing a barbell that is about chest high on a squat rack. Once you have selected the weights, grab the barbell using a pronated (palms facing forward) grip. Make sure to grip the bar wider than shoulder width apart from each other.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Stiff-Legged Deadlift", "Grasp a bar on the floor using an overhand grip. Stand with your torso straight and a shoulder-width stance. The knees should be slightly bent. This is your starting position.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Stiff-Legged Dumbbell Deadlift", "Grasp a couple of dumbbells holding them by your side at arm's length.
...
Repeat for the recommended amount of repetitions.");
INSERT INTO Workout (title, description) VALUES ("Sumo Deadlift", "Begin with a bar loaded on the ground. Approach the bar so that the bar intersects the middle of the feet. The feet should be set very wide, near the collars. Bend at the hips to grip the bar. The arms should be directly below the shoulders, inside the legs, and you can use a pronated grip, a mixed grip, or hook grip. Relax the shoulders, which in effect lengthens your arms.
...
INSERT INTO Workout (title, description) VALUES ("Superman", "To begin, lie straight and face down on the floor or exercise mat. Your arms should be fully extended in front of you. This is the starting position.
...
Repeat for the recommended amount of repetitions prescribed in your program.");
INSERT INTO Workout (title, description) VALUES ("Trail Running/Walking", "Running or hiking on trails will get the blood pumping and heart beating almost immediately. Make sure you have good shoes. While you use the muscles in your calves and buttocks to pull yourself up a hill, the knees, joints and ankles absorb the bulk of the pounding coming back down. Take smaller steps as you walk downhill, keep your knees bent to reduce the impact and slow down to avoid falling.");
INSERT INTO Workout (title, description) VALUES ("Walking, Treadmill", "To begin, step onto the treadmill and select the desired option from the menu. Most treadmills have a manual setting, or you can select a program to run. Typically, you can enter your age and weight to estimate the amount of calories burned during exercise. Elevation can be adjusted to change the intensity of the workout.
");
INSERT INTO Workout (title, description) VALUES ("Aerobic Dance", "Aerobic dance classes can be very effective for cardio training.");
INSERT INTO Workout (title, description) VALUES ("Swimming", "Swimming is an activity that can be both useful and recreational.");
INSERT INTO Workout (title, description) VALUES ("Cycling", "Cycling is the use of bicycles for transportation, recreation, exercise, or sport.");
INSERT INTO Workout (title, description) VALUES ("Rollerblading", "Rollerblading is a fun and exciting activity that involves skating while wearing inline skates, or rollerblades. Rollerblading exercises require balancing and moving the lower body in order to move on a pair of skates.");
